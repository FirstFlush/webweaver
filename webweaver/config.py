...
from webweaver.mapping import RouteMap, TemplateMap
from webweaver.scraping_modules.module_models import module_models
...
CAMPAIGN_MODULES_DIR = os.path.join(ROOT_DIR, "campaign_modules")
SOLO_SCRAPED_DATA_DIR = os.path.join(CAMPAIGN_MODULES_DIR, "_solo_scrapes")
...
all_models = core_models + module_models
