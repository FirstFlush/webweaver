...
class FuzzyHandler:
    ...
    @classmethod
    def get_handler_from_list(cls, word_list:list) -> "FuzzyHandler":
    ...
    @classmethod
    def get_handler_from_enum(cls, enum:Enum, exclude_values:set[str] | list[str]) -> "FuzzyHandler":
    ...
    @classmethod
    async def get_handler_from_model(cls, model:Model, field_name:str='name') -> "FuzzyHandler":
