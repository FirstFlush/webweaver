...
from webweaver.exceptions import BadMarkupError
...
class SpiderTag(Tag):
    ...
    def spider_text(self, selector:str, default=None) -> str|None:
        """Retrieves an HTML element's text, or returns default value if
        the element does not exist.
        """
        try:
            return self.select_one(selector).text
