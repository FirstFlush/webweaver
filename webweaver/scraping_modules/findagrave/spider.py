from webweaver.webscraping.spiders.spider_base import AsyncSpider#, PlaywrightSpider
...
# class FindABlehSpider(AsyncSpider):
    ...
    async def run(self):
        ...
        sp = self.get_parser(markup=res)
        names = sp.select(self.names)
