import os
from webweaver.config import SCRAPING_MODULES_DIR
...
def create_spider_module_files(sa:SpiderAsset, spider_type:str):
    ...
    with open(f'{module_dir}/spider.py', 'w') as f:
        f.write(f"from webweaver.webscraping.spiders.models import SpiderAsset\n")
        f.write(f"from webweaver.webscraping.spiders.spider_base import {spider_type}\n\n\n")
    ...
    with open(f'{module_dir}/validation.py', 'w') as f:
        ...
        f.write("from webweaver.webscraping.pipelines.pipeline_cleaner import PipelineCleaner\n\n\n")
    ...
    with open(f'{module_dir}/pipeline.py', 'w') as f:
        ...
        f.write("from webweaver.webscraping.pipelines.pipeline_base import Pipeline\n")
        f.write(f"from webweaver.scraping_modules.{sa.spider_name.lower()}.validation import {sa.spider_name}Schema\n\n\n")
    ...
    with open(f'{module_dir}/models.py', 'w') as f:
        ...
        f.write("from webweaver.webscraping.models import ScrapeModel\n\n\n")
